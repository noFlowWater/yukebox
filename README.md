...
| `PULSE_DIR` | (auto-detected) | Host PulseAudio directory path |
...
- Verify `PULSE_DIR` in `.env` matches your PulseAudio directory (e.g. `/run/user/1000/pulse`)
- Ensure user linger is enabled: `loginctl enable-linger $USER`
